...
Para modificar a resolução, basta mudar os dois valores escritos após a palavra res, sendo que o primeiro valor é o valor do width e o segundo valor é o valor do length. Na mesma linha, o terceiro número equivale a quantidade de raios que são enviados para fazer o antialiasing em cada pixel.
...
- Primeiro instanciar a resolução e o antialiasing, ex: res 400 200 100
...
- Após os materiais, instanciar as esferas, ex: sphere 5 0 0 1 madeira
